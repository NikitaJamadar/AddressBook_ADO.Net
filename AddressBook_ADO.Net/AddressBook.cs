...
namespace AddressBook_ADO.Net
{
    ...
    {
        SqlConnection Connection = new SqlConnection(@"Data Source=DESKTOP-2CM9D8H\MSSQLSERVER01;Initial Catalog=AddressBook_service;Integrated Security=True;Connect Timeout=30;Encrypt=False;TrustServerCertificate=False;ApplicationIntent=ReadWrite;MultiSubnetFailover=False");
        SqlCommand command;
